...
public class GrainsTest {
    ...
    public void countAtSquare1() {
        int result = grains.grainsOnSquare(1);
    ...
    public void countAtSquare2() {
        int result = grains.grainsOnSquare(2);
    ...
    public void countAtSquare3() {
        int result = grains.grainsOnSquare(3);
    ...
    public void countAtSquare4() {
        int result = grains.grainsOnSquare(4);
    ...
    public void countAtSquare16() {
        int result = grains.grainsOnSquare(16);
    ...
    public void countAtSquare32() {
        int result = grains.grainsOnSquare(32);
    ...
    public void countAtSquare64() {
        int result = grains.grainsOnSquare(64);
